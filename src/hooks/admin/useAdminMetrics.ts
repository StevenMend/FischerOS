...
export const useAdminMetrics = (): UseAdminMetricsResult => {
  ...
  useEffect(() => {
    ...
    const subscription = supabase
      ...
      .on('postgres_changes', { event: '*', schema: 'public', table: 'service_requests' }, onRealtimeChange)
      .on('postgres_changes', { event: '*', schema: 'public', table: 'restaurant_reservations' }, onRealtimeChange)
      .on('postgres_changes', { event: '*', schema: 'public', table: 'spa_appointments' }, onRealtimeChange)
      .on('postgres_changes', { event: '*', schema: 'public', table: 'tour_bookings' }, onRealtimeChange)
      .subscribe();
