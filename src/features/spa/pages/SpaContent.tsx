// src/features/spa/pages/SpaContent.tsx — Reusable content (no full-page shell)
import React, { useState, useMemo } from 'react';
import { Crown, Heart, Clock, Star, Flower2 } from 'lucide-react';
                ...
                <div className="mb-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {treatment.benefits.slice(0, 3).map((benefit) => (
                      <span key={benefit} className="px-2 py-1 bg-surface/50 rounded-lg text-xs text-foreground">
                        {benefit}
                      </span>
                    ))}
                  </div>
